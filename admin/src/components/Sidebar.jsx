...
const Sidebar = () => {
  ...
  const sidebarLinks = [
    { name: "Dashboard", to: "/dashboard", icon: dash },
  ...
  return (
    <div className="md:w-40 w-16 border-r h-[550px] text-base border-gray-300 pt-4 flex flex-col transition-all duration-300">
